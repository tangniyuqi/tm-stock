  ...
  <div>
    <div class="gva-search-box">
      <div class="header-section">
        <h2 class="main-title">AI选股器</h2>
        <p class="sub-title">输入条件，多维筛选，精准捕捉</p>
      </div>
    ...
    <div class="gva-table-box">
      ...
      <el-table v-else v-loading="loading" :data="paginatedData" style="width: 100%" height="calc(100vh - 520px)" border stripe scrollbar-always-on>
      ...
      <div class="gva-pagination" v-if="tableData.length > 0">
