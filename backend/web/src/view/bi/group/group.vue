  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="id" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="left" label="客户端ID" prop="client_id" width="120" />

        <el-table-column align="left" label="GID" prop="gid" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
          <template #default="scope">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateGroupFunc(scope.row)">编辑</el-button>
...
<script setup>
import { createGroup, deleteGroup, deleteGroupByIds, updateGroup, findGroup, getGroupList } from '@/api/bi/group';
