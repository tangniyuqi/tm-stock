      ...
      <div class="gva-theme-section-content">
        <div class="gva-theme-card-bg">
          <div class="gva-theme-card-white flex items-center justify-between">
            ...
            <g-button variant="destructive" size="sm" class="rounded-lg font-medium hover:-translate-y-0.5"
        ...
        <div class="gva-theme-card-bg">
          <div class="flex items-start gap-5">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm gva-theme-text-sub mb-5 leading-relaxed">基于 Vue3 + Gin 的全栈开发基础平台，提供完整的后台管理解决方案</p>
...
const handleResetConfig = async () => {
  try {
    await ElMessageBox.confirm('确定要重置所有配置吗？此操作不可撤销。', '重置配置', {
