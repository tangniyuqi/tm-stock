<template>
  <div id="userLayout" class="relative h-full w-full bg-white dark:bg-slate-900 md:h-screen">
    ...
    <!-- 左侧登录区 -->
    <div class="relative z-10 flex h-full w-full items-center justify-center md:w-1/2">
      <div class="w-4/5 md:w-96">
        ...
        <el-form ref="loginForm" :model="loginFormData" :rules="rules" :validate-on-rule-change="false"
          ...
          <el-form-item class="mb-6">
            <el-button class="btn-primary shadow shadow-active h-11 w-full" type="primary" size="large"
              @click="submitForm">登 录</el-button>
          </el-form-item>
          <el-form-item v-if="isDev" class="mb-6">
            <el-button class="btn-hollow h-11 w-full" type="primary" plain size="large"
