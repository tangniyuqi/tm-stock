# 底部对话框 xActionModal
-------
<ViewMobile url="/pages/fankui/action-modal" />
...
| showConfirm | `显示取消按钮`<br> | `boolean` | `true` |
...
| bgColor | `弹层的背景`<br> | `string` | `"white"` |
| darkBgColor | `弹层的暗黑背景，如果为空取sheetDarkColor`<br> | `string` | `""` |
| btnColor | `空值取全局主题值。`<br> | `string` | `""` |
| btnText | `确认按钮的文本`<br> | `string` | `""` |
| btnFontColor | `空值最自动计算文本色。`<br> | `string` | `""` |
...
<<< ../../../../pages/fankui/action-modal.uvue{vue}
