...
| 付费墙 | **列表免费**，点题材进详情才收费 | 见下方「付费边界」 |
| 非交易日 | 空态，不回填 | 回填 = 假数据 |

## 6.1 付费边界（已定 · 2026-07-30）

**本页整体免费。** 付费墙不在本页，而在题材详情页的中层。

三段漏斗：

| 段 | 内容 | 收费 | 作用 |
|---|------|------|------|
| ① 题材动态列表（本页） | 事件标题 + 题材标签 + **题材层**涨跌幅 | 免费 | 引流、建立"这里有信息"的印象 |
| ② 题材详情·顶层 | 题材是什么 + 一句话解读 + 来源 | 免费 | 让用户确认"这正是我想了解的" |
| ③ 题材详情·中层及以下 | **产业链环节 + 成分股 + 归属依据** | **付费**（含试吃） | 独家价值所在 |

**为什么这么切**：
- **题材层涨跌幅没有护城河**——同花顺、东财免费就给板块涨跌幅，圈起来只会赶客。
- 真正别人给不了的是**"这家公司凭什么被归到这个环节"的原文依据**。付费墙就该压在这。
- 付费点卡在**意图最强的那一刻**（用户已经点进来、已经知道这题材是什么，正想看构成）。
- 首屏收费会直接掐死激活率——**没人会为没见过的东西付钱**，而 G1 要验的正是付费意愿。
